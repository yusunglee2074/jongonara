...
### Up-to-date boilerplate for an easy start with TypeScript, React, and Electron.
...
```bash
git clone --depth=1 git@github.com:snnsnn/electron-react-typescript.git <your-project-name>
```
...
## About this project
This project was forked from [https://github.com/Robinfr/electron-react-typescript](https://github.com/Robinfr/electron-react-typescript). Redux and related dependencies are replaced with React Hooks.

## License
MIT © [SnnSnn](https://github.com/snnsnn)
